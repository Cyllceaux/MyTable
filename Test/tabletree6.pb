...
UseModule MyTable
	...
	Global window=OpenWindow(#PB_Any,0,0,800,600,"TableTree 6 (Fixed cols, Editable, Zebra, Font)",#PB_Window_SystemMenu|#PB_Window_ScreenCentered|#PB_Window_SizeGadget|#PB_Window_MaximizeGadget|#PB_Window_MinimizeGadget)
	
	XIncludeFile "menu.pb"
	
	Global canvas=CanvasGadget(#PB_Any,0,by,WindowWidth(window),WindowHeight(window)-by,#PB_Canvas_Container|#PB_Canvas_Keyboard)
	...
	Global *tree.MyTableTable=MyTableCreateTree(window,canvas,vscroll,hscroll,#MYTABLE_TABLE_FLAGS_ZEBRA|#MYTABLE_TABLE_FLAGS_EDITABLE|#MYTABLE_TABLE_FLAGS_CHECKBOXES|#MYTABLE_TABLE_FLAGS_BORDER|#MYTABLE_TABLE_FLAGS_MULTISELECT|#MYTABLE_TABLE_FLAGS_SORTABLE|#MYTABLE_TABLE_FLAGS_RESIZABLE)
	...
	*col=*tree\AddCol("Test 3",500,rowImageSub2)
