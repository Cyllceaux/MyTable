...
UseModule MyTable
	UseModule MyFont
		...
		Define Dim fonts(3)
		fonts(0)=MyFontCreateFont("Arial",12,#PB_Font_HighQuality|#PB_Font_Bold)
		fonts(1)=MyFontCreateFont("Arial",12,#PB_Font_HighQuality|#PB_Font_Italic)
		fonts(2)=MyFontCreateFont("Arial",12,#PB_Font_HighQuality|#PB_Font_StrikeOut)
		fonts(3)=MyFontCreateFont("Arial",12,#PB_Font_HighQuality|#PB_Font_Underline)
