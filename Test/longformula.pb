...
UseModule MyTable
	...
	Define *table.MyTableTable=MyTableGridRegister(mainWindow,canvasFormula,hscrollFormula,vscrollFormula,100,10,#MYTABLE_TABLE_FLAGS_GRID_FORMULA_DEFAULT)
	...
	*table\SetRedraw(#False)
	...
	For frow=0 To 100
		*table\SetCellFormula(frow,0,"1")
		For fcol=1 To 10
			*table\SetCellFormula(frow,fcol,"=RC(-1)+1")
		Next
	Next
