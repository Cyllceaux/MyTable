...
UseModule MySplitter
	...
	Global window=OpenWindow(#PB_Any,0,0,800,600,"Splitter4",#PB_Window_SystemMenu|#PB_Window_ScreenCentered|#PB_Window_SizeGadget|#PB_Window_MaximizeGadget|#PB_Window_MinimizeGadget)
	Global *splitter.MySplitter=MySplitterCreateSplitter(0,0,WindowWidth(window),WindowHeight(window),0,0,#MYSPLITTER_FLAGS_SECONDFIXED)
