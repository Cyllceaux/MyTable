...
UseModule MyTable
	...
	Define *appstyle.MyTableStyleApplication=*app\GetStyle()
	Define *colstyle.MyTableStyleCol=0
	Define *cellstyle.MyTableStyleCell=0
	...
	*termine\SetEmptyText("An diesen 7 Tagen ist nichts für sie geplant")
	...
	Define *tablestyle.MyTableStyleTable=*favoriten\GetStyle()
	*tablestyle\SetBackColor(#Gray)
	*tablestyle\SetFrontColor(#Gray)
	*tablestyle\SetForeColor(#White)
	
	*tablestyle=*ordner\GetStyle()
	*tablestyle\SetBackColor(#Gray)
	*tablestyle\SetFrontColor(#Gray)
	*tablestyle\SetForeColor(#White)
	
	*tablestyle=*mails\GetStyle()
	*tablestyle\SetBackColor(#Gray)
	*tablestyle\SetFrontColor(#Gray)
	*tablestyle\SetForeColor(#White)
	...
	*col=*termine\AddCol("##:##",#PB_Ignore)
	...
	Define *rowStyle.MyTableStyleRow=*row\GetStyle()
